...
PACKAGENAME = 'sqre-uservice-ltdstatus'
DESCRIPTION = 'LSST The Docs microservice framework to get LTD product status'
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'sqre-uservice-ltdstatus = uservice_ltdstatus:standalone'
        ]
    }
)
